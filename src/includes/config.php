...
define('TELEGRAM_ENABLED',  false);                        // เปลี่ยนเป็น true เมื่อพร้อม
define('TELEGRAM_BOT_TOKEN','YOUR_TELEGRAM_BOT_TOKEN');   // ใส่ Token จาก BotFather
define('TELEGRAM_CHAT_ID',  'YOUR_TELEGRAM_CHAT_ID');     // ใส่ Chat ID ของ Group/Channel
